...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (menuItem) {
                case ADD_NEW_BIKE ->
                        OperationsWithBicycles.insertNewBike(bikeDao);
                case PRINT_ALL_BICYCLES ->
                        OperationsWithBicycles.printAllBicycles(bikeDao);
                case EDIT_BIKE_BY_ID ->
                        OperationsWithBicycles.editBike(bikeDao);
                case DELETE_BIKE_BY_ID ->
                        OperationsWithBicycles.deleteBike(bikeDao);
                case SEARCH_BICYCLES_WITH_LOWER_PRICE ->
                        OperationsWithBicycles.searchByFieldPrice(bikeDao);
